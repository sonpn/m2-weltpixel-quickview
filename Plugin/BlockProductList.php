...
class BlockProductList
{
        ...
        )
    {
        ...
        if ($isEnabled) {
            ...
            return $result . '<a class="weltpixel-quickview '.$buttonStyle.'" data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><div>1111111111111111111</div><span>' . __("Quickview") . '</span></a>';
        }
